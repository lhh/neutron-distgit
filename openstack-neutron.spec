...
Requires:       iptables
Requires:       iputils
# In Centos 7 "tc" library is provided by iproute package
%if 0%{?fedora} || 0%{?rhel} > 7
Requires:       iproute-tc
%else
Requires:       iproute
...
%changelog
* Thu Feb 04 2021 RDO <dev@lists.rdoproject.org> 1:15.3.2-1
- Update to 15.3.2

* Thu Jan 28 2021 RDO <dev@lists.rdoproject.org> 1:15.3.1-1
- Update to 15.3.1

* Wed Oct 07 2020 RDO <dev@lists.rdoproject.org> 1:15.3.0-1
- Update to 15.3.0
...
* Thu Dec 19 2019 RDO <dev@lists.rdoproject.org> 1:15.0.1-1
- Update to 15.0.1

* Wed Oct 16 2019 RDO <dev@lists.rdoproject.org> 1:15.0.0-1
- Update to 15.0.0

* Fri Oct 11 2019 RDO <dev@lists.rdoproject.org> 1:15.0.0-0.2.0rc1
